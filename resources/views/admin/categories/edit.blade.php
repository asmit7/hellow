                ...
                <div class="mt-10 w-1/2 space-y-8 divide-gray-200">
                    <form method="POST" enctype="multipart/form-data" action="{{ route('admin.categories.update', $category->id) }}">
                        ...
                        <div class="sm:col-span-6">
                            ...
                            <div class="mt-1">
                                <input type="text" id="name" value="{{$category->name}}" name="name" class="block w-full transition
                        ...
                        <div class="sm:col-span-6">
                            ...
                            <div class="mt-1">
                                <input type="file" id="image" value="{{$category->image}}" name="image" class="p-2 block w-full transition
                                    duration-150 ease-in-out appearance bg-white border  border-gray-400 rounded" />
                            </div>
                        </div>
                        <div class="sm:col-span-6">
