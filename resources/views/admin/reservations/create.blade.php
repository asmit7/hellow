                ...
                <div class="mt-10 w-1/2 space-y-8 divide-gray-200">
                    <form method="POST" action="{{ route('admin.reservations.store') }}">
                        ...
                        <div class="sm:col-span-6">
                            ...
                            <div class="mt-1">
                                <input type="text" id="first_name" name="first_name" class="block w-full transition
                        ...
                        <div class="sm:col-span-6">
                            ...
                            <div class="mt-1">
                                <input type="text" id="last_name" name="last_name" class="block w-full transition
                                 duration-150 ease-in-out appearance  bg-white border  border-gray-400 rounded" />
                            </div>
                            @error('last_name')
                            <div class="text-sm text-red mb-2">{{$message}}</div>
                        ...
                        <div class="sm:col-span-6">
                            ...
                            <div class="mt-1">
                                <input type="email" id="email" name="email" class="block w-full transition
                                 duration-150 ease-in-out appearance  bg-white border  border-gray-400 rounded" />
                            </div>
                            @error('email')
                            <div class="text-sm text-red mb-2">{{$message}}</div>
                        ...
                        <div class="sm:col-span-6">
                            ...
                            <div class="mt-1">
                                <input type="text" id="tel_number" name="tel_number" class="block w-full transition
                                 duration-150 ease-in-out appearance  bg-white border  border-gray-400 rounded" />
                            </div>
                            @error('tel_number')
                            <div class="text-sm text-red mb-2">{{$message}}</div>
                        ...
                        <div class="sm:col-span-6">
                            ...
                            <div class="mt-1">
                                <input type="number" id="gust_number" name="gust_number" class="block w-full transition
                                 duration-150 ease-in-out appearance  bg-white border  border-gray-400 rounded" />
                            </div>
                            @error('gust_number')
                            <div class="text-sm text-red mb-2">{{$message}}</div>
                        ...
                        <div class="sm:col-span-6">
                            ...
                            <div class="mt-1">
                                <input type="datetime-local" id="res_date" name="res_date" class="block w-full transition
                                 duration-150 ease-in-out appearance  bg-white border  border-gray-400 rounded" />
                            </div>
                            @error('res_date')
                            <div class="text-sm text-red mb-2">{{$message}}</div>
